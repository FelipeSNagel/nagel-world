...
run_cmd "lp group default permission set quickshop.player true"
run_cmd "lp group default permission set quickshop.use true"
run_cmd "lp group default permission set quickshop.create.cmd true"
...
run_cmd "lp group default permission set quickshop.create.changeitem true"
...
run_cmd "lp group default permission set quickshop.search true"
